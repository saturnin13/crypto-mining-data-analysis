...
class ZCLBlockchainDataScrapper(GenericBlockchainDataScrapper):
    ...
    def _get_primary_url(self, id):
        return "http://explorer.zclmine.pro/insight-api-zcash/block/" + str(self.__block_hash_value)

    def _pre_processing_page_loading(self, id):
        self.__block_hash_value = self.__find_hash(self.http.get_request("http://explorer.zclmine.pro/insight-api-zcash/block-index/" + str(id["block_number"])))
