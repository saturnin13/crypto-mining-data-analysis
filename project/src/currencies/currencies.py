...
class Currencies(Enum):
    ...
    def get_algorithm(self):
        ...
        elif (self == Currencies.BTG or self == Currencies.ZEC):
    ...
    def starting_block(self):
        if(self == Currencies.GRS or self == Currencies.ETH or self == Currencies.XMR or self == Currencies.BCN or self == Currencies.FCN
                or self == Currencies.QCN or self == Currencies.EXP or self == Currencies.UBQ or self == Currencies.ZEC):
            return 1
