...
data_analyser2 = DataAnalyser([item for item in Currencies], [item for item in GraphicCards], starting_datetime=datetime.datetime(2017, 6, 1), end_datetime=datetime.datetime.now(),
