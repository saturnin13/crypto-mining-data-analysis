...
data_analyser = DataAnalyser([item for item in Currencies], [item for item in GraphicCards], starting_datetime=datetime.datetime(2015, 1, 1), end_datetime=datetime.datetime(2018, 1, 1),
