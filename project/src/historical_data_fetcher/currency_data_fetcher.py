...
class CurrencyDataFetcher:
    ...
    def fill_database(self, currency, time_delta=datetime.timedelta(hours=1), sleep_time=1, block_number=1):
        ...
        datetime_limit = datetime.datetime(current_date_time.year, current_date_time.month, current_date_time.day, current_date_time.hour)
...
test.fill_database(Currencies.GRS, sleep_time=2, block_number=1)
